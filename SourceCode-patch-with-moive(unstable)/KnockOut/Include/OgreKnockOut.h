#ifndef __OgreKnockOut_h_
#define __OgreKnockOut_h_
...
namespace KnockOut
{
	...
	protected:
		...
		KnockOutFrameListener *mKnockOutFrameListener;
		...
		KnockOutFrameListener* mFrameListener;
...
#endif // #ifndef __OgreKnockOut_h_